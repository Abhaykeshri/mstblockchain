...
const featureItems = [
  {
    ...
    description: 'Every item is a verifiable blockchain asset in the player\'s own wallet. The game company cannot take it away, modify it, or delete it unilaterally.',
    icon: CheckCircle2
  },
  {
    title: 'Rarity That is Provable',
    description: 'Scarcity is defined and enforced by smart contracts. Rarity claims are transparent and mathematically verifiable — no hidden minting surprises.',
    icon: ShieldCheck
  },
  {
    title: 'Open Marketplace Trading',
    description: 'Players trade freely in peer-to-peer markets with smart contract protection. Developers earn automatic royalties on every legitimate secondary sale',
    icon: Database
  }
];
...
const stats = [
  { label: 'Asset Ownership', value: 'True' },
  { label: 'Provable Rarity', value: 'On-Chain' },
  { label: 'Royalty Enforcement', value: 'Auto' },
  { label: 'Secondary Markets', value: 'Open' }
];
