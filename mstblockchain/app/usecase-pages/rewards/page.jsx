...
const featureItems = [
  {
    title: 'Tokens You Actually Own',
    description: 'Loyalty tokens on MST are digital assets in your own wallet — not points in a brand\'s database. You control them completely.',
    icon: CheckCircle2
  },
  {
    title: 'Transparent Rules',
    description: 'All earn conditions, expiry rules, and redemption terms are written into smart contracts. Brands cannot change the rules after you have earned your tokens.',
    icon: ShieldCheck
  },
  {
    title: 'Spend Across Brands',
    description: 'Tokens can be redeemed across a growing network of partner brands — far more flexibility than any traditional single-brand loyalty programme.',
    icon: Database
  }
];
...
const stats = [
  { label: 'Cross-Brand Redemption', value: 'Open' },
  { label: 'Token Issuance', value: 'Real-Time' },
  { label: 'Hidden Rule Changes', value: 'Zero' },
  { label: 'Campaign Transparency', value: 'Full ' }
];
